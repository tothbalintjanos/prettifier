...
var autoComplete = (function () {
  function e(e) {
    ...
    if (document.querySelector) {
      ...
      for (
        var a = "object" == typeof l.selector ? [l.selector] : document.querySelectorAll(l.selector), u = 0;
        u < a.length;
        u++
      ) {
        var i = a[u]
        ;(i.sc = document.createElement("div")),
          ...
          (i.updateSC = function (e, t) {
            ...
            if (
              ((i.sc.style.left =
                Math.round(o.left + (window.pageXOffset || document.documentElement.scrollLeft) + l.offsetLeft) + "px"),
              (i.sc.style.top =
                Math.round(o.bottom + (window.pageYOffset || document.documentElement.scrollTop) + l.offsetTop) + "px"),
              (i.sc.style.width = Math.round(o.right - o.left) + "px"),
              !e &&
                ((i.sc.style.display = "block"),
                i.sc.maxHeight ||
                  (i.sc.maxHeight = parseInt(
                    (window.getComputedStyle ? getComputedStyle(i.sc, null) : i.sc.currentStyle).maxHeight
                  )),
                i.sc.suggestionHeight ||
                  (i.sc.suggestionHeight = i.sc.querySelector(".autocomplete-suggestion").offsetHeight),
                i.sc.suggestionHeight))
            )
              if (t) {
