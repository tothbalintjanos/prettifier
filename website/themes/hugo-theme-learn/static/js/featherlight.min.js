      ...
      ;(c.prototype = {
            ...
            i = u(
              n.background ||
                [
                  ...
                  '<div class="' + r + '-content">',
                  '<button class="' + r + "-close-icon " + n.namespace + '-close" aria-label="Close">',
                  n.closeIcon,
                  "</button>",
        ...
        getContent: function () {
          ...
          var t = this,
            ...
            i = t.target || r || "",
            o = e[t.type]
          if ((!o && i in e && ((o = e[i]), (i = t.target && r)), (i = i || n("href") || ""), !o))
          ...
          if (!o) {
            ...
            if (
              ...
              u.each(t.contentFilters, function () {
                return (
                  (o = e[this]).test && (i = o.test(s)), !i && o.regex && s.match && s.match(o.regex) && (i = s), !i
                )
              }),
              !i)
            )
              return (
                "console" in window &&
                  window.console.error(
                    "Featherlight: no content filter found " + (s ? ' for "' + s + '"' : " (no target specified)")
                  ),
                !1
              )
          }
        ...
        resize: function (e, t) {
          if (
            ...
            this.$content.parent().width() < e || this.$content.parent().height() < t)
          ) {
        ...
        u.extend(c, {
          ...
          contentFilters: {
            ...
            image: {
              ...
              process: function (e) {
                ...
                return (
                  (n.onload = function () {
                    ;(r.naturalWidth = n.width), (r.naturalHeight = n.height), t.resolve(r)
                  }),
                  (n.onerror = function () {
                    t.reject(r)
                  }),
              ...
              e &&
                ...
                u.each(e.attributes, function () {
                  ...
                  if (e) {
                    var t = this.value,
                      n = u.camelCase(e[1])
                    if (0 <= u.inArray(n, r.functionAttributes)) t = new Function(t)
                    else
                      try {
                        t = JSON.parse(t)
                      } catch (e) {}
          ...
          attach: function (i, o, a) {
            var s = this
            "object" != typeof o || o instanceof u != !1 || a || ((a = o), (o = void 0))
            var c,
            ...
            return i.on(l.openTrigger + "." + l.namespace, l.filter, t), { filter: l.filter, handler: t }
          },
          current: function () {
            var e = this.opened()
