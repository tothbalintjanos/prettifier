...
!(function (e, t, n) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses &&
      ((t += " " + n + e.join(" " + n)), x ? (b.className.baseVal = t) : (b.className = t))
  }
  function a(e, t) {
    return !!~("" + e).indexOf(t)
  }
  ...
  function m(e, t, o, i) {
    ...
    for (var f, d, m, h, g, v = ["modernizr", "tspan", "samp"]; !P.style && v.length; )
  ...
  function g(e, t, n) {
    var o
    for (var i in e) if (e[i] in t) return n === !1 ? e[i] : ((o = t[e[i]]), r(o, "function") ? h(o, n || t) : o)
    return !1
  }
